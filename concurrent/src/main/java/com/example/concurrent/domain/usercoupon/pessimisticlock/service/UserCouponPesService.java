package com.example.concurrent.domain.usercoupon.pessimisticlock.service;
...
@Transactional
public class UserCouponPesService {

    private final UserCouponPesRepository userCouponPesRepository;
    private final UserRepository userRepository;
    private final CouponRepository couponRepository;

    public void issueCouponUsingPessimisticLock(Long userId, Long couponId) {
